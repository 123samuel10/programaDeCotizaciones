        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Crea un proveedor para asociarlo a seguimientos de ventas.
                </p>
            </div>
    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <form method="POST" action="{{ route('admin.proveedores.store') }}" class="space-y-5">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input name="whatsapp" value="{{ old('whatsapp') }}" placeholder="+57..."
                                   class="w-full rounded-xl border border-gray-200 dark:border-gray-700
                                          bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                        </div>
                        ...
                        <div>
                            ...
                            <input name="pais" value="{{ old('pais') }}"
                                   class="w-full rounded-xl border border-gray-200 dark:border-gray-700
                                          bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="notas" rows="4"
                                  class="w-full rounded-2xl border border-gray-200 dark:border-gray-700
                                         bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4"
                                  placeholder="Ej: Horarios, condiciones, tiempos de respuesta...">{{ old('notas') }}</textarea>
                    </div>
